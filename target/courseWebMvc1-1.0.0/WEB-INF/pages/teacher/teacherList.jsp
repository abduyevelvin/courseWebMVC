...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content container-fluid">
            ...
            <table id="teacherTableId" class="table table-bordered table-striped">
                <thead>
                <tr>
                    <th>No</th>
                    <th>Name</th>
                ...
                <c:forEach items="${teacherList}" var="tc">
                    <tr>
                        ...
                        <td>${tc.surname}</td>
                        <td>${tc.address}</td>
                        <td><fmt:formatDate pattern="yyyy-MM-dd" value="${tc.dob}" /></td>
                        <td><a href="javascript: editTeacher('${tc.id_teacher}');" class="btn btn-info"><i class="fa fa-pencil-square-o"></i></a></td>
                        <td><a href="javascript: deleteTeacher('${tc.id_teacher}');" class="btn btn-danger"><i class="fa fa-times"></i></a></td>
                    </tr>
                </c:forEach>
                </tbody>
            </table>
...
<div class="modal modal-info fade-scale" id="teacherEditModalId">
