...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content container-fluid">
            ...
            <table id="studentTableId" class="table table-bordered table-striped">
                <thead>
                <tr>
                    <th>No</th>
                    <th>Name</th>
                ...
                <c:forEach items="${studentList}" var="sl">
                    <tr>
                        ...
                        <td>${sl.surname}</td>
                        <td>${sl.address}</td>
                        <td><fmt:formatDate pattern="yyyy-MM-dd" value="${sl.dob}" /></td>
                        <td>${sl.teacherName} ${sl.teacherSurname}</td>
                        <td><a href="javascript: editStudent('${sl.id_student}');" class="btn btn-info"><i class="fa fa-pencil-square-o"></i></a></td>
                        <td><a href="javascript: deleteStudent('${sl.id_student}');" class="btn btn-danger"><i class="fa fa-times"></i></a></td>
                    </tr>
                </c:forEach>
                </tbody>
            </table>
...
<div class="modal modal-info fade-scale" id="studentEditModalId">
