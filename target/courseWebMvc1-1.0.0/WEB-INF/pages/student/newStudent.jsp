    ...
    <div class="content-wrapper">
        ...
        <section class="content container-fluid">
            ...
            <div class="form-group">
                <label>Name</label>
                <input type="text" class="form-control" id="studentNameId" placeholder="Enter Student Name..." />
            </div>
            <div class="form-group">
                <label>Surname</label>
                <input type="text" class="form-control" id="studentSurnameId" placeholder="Enter Student Surname..." />
            </div>
            <div class="form-group">
                <label>Address</label>
                <textarea class="form-control" id="studentAddressId" placeholder="Enter Student Address..."></textarea>
            </div>
            <div class="form-group">
                <label>Birth Date</label>
                <input type="text" class="form-control" id="studentDobId" placeholder="Enter Student Birth Date..." />
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <button type="button" id="addStudentBtnId" class="btn btn-block btn-primary btn-flat">Create</button>
            </div>
